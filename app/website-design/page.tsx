...
const foundations = [
  ["سرعة وتجربة جوال", "الموقع يجب أن يفتح ويُقرأ ويُستخدم بسهولة قبل أي حديث عن الشكل."],
  ["SEO قابل للفهم", "هيكل وعناوين وروابط وسكيما تساعد Google على فهم الصفحة والموضوع."],
  ["CRO ومسار قرار", "الرسالة والثقة والـCTA والنماذج تُبنى لتقليل التردد لا لملء الصفحة."],
  ["تتبع وتحليلات", "نعرف مصدر الزيارة وما الذي تحوّل، بدل الاكتفاء بعدد الزيارات."],
];
...
export default function WebsiteDesignPage() {
  const whatsappHref = "https://wa.me/97339066649?text=" + encodeURIComponent("مرحبًا ديوانك، أريد مناقشة تصميم أو تطوير موقع. النشاط هو: ");
  const schema = {
