...
const showcaseSchemaItems = [
  ["تصميم محتوى لتطبيق ترفيهي", "نموذج تصميم سوشيال ميديا لتطبيق ترفيهي بإخراج بصري حديث."],
  ["تصميم محتوى لمقهى", "نموذج محتوى إنستقرام لمقهى عربي يعرض المنتج بأسلوب دافئ واحترافي."],
  ["تصميم محتوى للسفر والسياحة", "نموذج تصميم سوشيال ميديا لعلامة سفر وسياحة وتجربة حجز."],
  ["تصميم إعلان لمطعم", "نموذج إعلان سوشيال ميديا لمطعم مع تكوين بصري قوي ودعوة واضحة للطلب."],
  ["تصميم محتوى لمخبز", "نموذج تصميم محتوى إنستقرام لمخبز وكروسان بهوية مرحة وعرض منتج احترافي."],
  ["تصميم محتوى لخدمات احترافية", "نموذج تصميم سوشيال ميديا لخدمات واستراتيجية أعمال موجهة للسوق الخليجي."],
  ["تصميم محتوى لمنتجات عناية", "نموذج تصميم إعلان سوشيال ميديا لمنتجات عناية شخصية بهوية نظيفة وواضحة."],
];
...
export default function ContentOfferPage() {
  ...
  const showcaseSchema = {
    ...
    description: "نماذج تصميم محتوى إنستقرام لقطاعات مختلفة توضح مستوى واتجاهات التنفيذ.",
    itemListElement: showcaseSchemaItems.map(([name, description], index) => ({
      "@type": "ListItem",
      position: index + 1,
      item: {
        "@type": "CreativeWork",
