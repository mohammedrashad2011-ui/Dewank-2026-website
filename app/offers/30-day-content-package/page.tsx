...
const faqItems = [
  ["كم سعر إدارة محتوى إنستقرام لمدة شهر؟", "السعر المعروض في الصفحة هو سعر الباقة الكامل لبلدك، وتشمل 12 بوستًا و3 ستوري وريل واحد مع الأفكار والكابشنات وخطة النشر."],
