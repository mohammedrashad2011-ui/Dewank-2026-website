...
const faqItems = [
  ["كم سعر إدارة محتوى إنستقرام لمدة شهر؟", "يظهر السعر المناسب تلقائيًا حسب بلد الزائر. تشمل الباقة 12 بوستًا و3 ستوري وريل واحد مع الأفكار والكابشنات وخطة النشر."],
