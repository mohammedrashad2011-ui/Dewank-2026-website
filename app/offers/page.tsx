...
export const metadata: Metadata = createMetadata({
  title: "عروض ديوانك | باقات تسويق ومحتوى وصفحات هبوط",
  description: "اكتشف عروض ديوانك الجاهزة: باقة محتوى إنستقرام لمدة شهر، وباقة تصميم صفحة هبوط احترافية مع خيار دومين واستضافة لمدة عام.",
  path: "/offers",
  keywords: ["عروض تسويق رقمي", "باقة محتوى انستقرام", "تصميم صفحة هبوط", "أسعار إدارة السوشيال ميديا", "landing page السعودية"],
});
...
export default function OffersPage() {
  ...
  return (
    <main className="inner-page offers-page">
      ...
      <section className="shell offers-grid offers-grid-two" aria-label="عروض ديوانك الحالية">
        ...
        <aside className="offers-note offers-note-wide">
