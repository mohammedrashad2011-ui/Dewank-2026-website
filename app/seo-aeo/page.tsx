...
export default function SeoAeoPage() {
  ...
  return (
    <main className="sa-page">
      ...
      <section className="sa-hero shell">
        <div className="sa-hero-copy">
          <div className="sa-kicker"><span>SEO</span><span>AEO</span><span>SEARCH SYSTEMS</span></div>
          <h1>لا نطارد ترتيبًا فقط.<br/><em>نبني حضورًا يُفهم ويُختار.</em></h1>
          <p>نحسّن موقعك ليظهر في Google ويصبح أوضح لمحركات الإجابة والذكاء الاصطناعي، عبر بنية تقنية قوية، محتوى منظم، Schema، وربط بين الظهور والتحويل.</p>
          <div className="sa-actions"><Link className="button primary" href="/contact">اطلب مراجعة موقعك <span>←</span></Link><a href="#process">استعرض المنهج</a></div>
        </div>
        <div className="sa-search-board" aria-label="تصور لظهور الموقع في البحث والإجابات">
          <div className="sa-board-top"><span>SEARCH VISIBILITY</span><b>LIVE MAP</b></div>
          <div className="sa-query">كيف أختار شركة SEO في السعودية؟</div>
          <div className="sa-answer"><small>ANSWER SIGNAL</small><strong>صفحة واضحة + خبرة + Schema + سياق موثوق</strong><p>ليست كثافة الكلمات هي الهدف؛ بل سهولة الفهم والاختيار.</p></div>
          <div className="sa-signals"><div><small>INDEXING</small><b>Healthy</b></div><div><small>TOPICS</small><b>Connected</b></div><div><small>ANSWERS</small><b>Structured</b></div></div>
        </div>
      </section>
