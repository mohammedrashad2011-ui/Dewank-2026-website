...
export default function BrandNameGuide() {
  ...
  const schema = { "@context": "https://schema.org", "@graph": [
    { "@type": "Article", "@id": `${url}#article`, headline: title, description, inLanguage: "ar", datePublished: "2026-08-04", dateModified: "2026-08-04", mainEntityOfPage: url, author: { "@id": organizationId }, publisher: { "@id": organizationId }, about: ["اختيار اسم تجاري", "تسمية العلامات التجارية", "البحث عن العلامات في السعودية"] },
